module "nuclea-teste-2" {
  ...
  control_tower_parameters = {
    ...
    ManagedOrganizationalUnit = "LAB (ou-2q9f-xqhtmyku)"
  ...
  account_customizations_name = "laboratory-customizations"
}
...
module "nuclea-teste-3" {
  ...
  control_tower_parameters = {
    ...
    ManagedOrganizationalUnit = "LAB (ou-2q9f-v8x6ldc0)"
    SSOUserEmail     = "sustentacaocloud@nuclea.com.br"
    SSOUserFirstName = "Sustentacao"
    SSOUserLastName  = "Cloud"
  }
...
module "nuclea-teste1-LAB" {
  source = "./modules/aft-account-request"

  control_tower_parameters = {
    AccountEmail = "nuclea-aws-accounts+nuclea-teste1-LAB@nuclea.com.br"
    AccountName  = "nuclea-teste1-LAB"
    ManagedOrganizationalUnit = "LAB (ou-2q9f-4el7724y)"
    SSOUserEmail     = "sustentacaocloud@nuclea.com.br"
    SSOUserFirstName = "Sustentacao"
    SSOUserLastName  = "Cloud"
  }
  ...
  custom_fields           = merge(local.aft_environment_parameters_virginia, {
    ipam_pool_id          = "ipam-pool-xxxxxxxxxxxxx"
    dns_private_zone      = "nuclea-teste1-LAB"
    atlas_account         = false
    account_name          = "nuclea-teste1-LAB"
    cloudflow_enable      = false
  })
